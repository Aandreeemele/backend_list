...
app.use(cors({
  origin: 'http://localhost:3000/api/get-tasks', // Aquí puedes ajustar esto al origen de tu frontend
}));
...
const db = mysql.createConnection({
  ...
  password: 'Diami2025', // Usa la contraseña que tengas configurada en MySQL
